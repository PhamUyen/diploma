package com.uyenpham.diploma.myenglish.customviews.customviews.playvideo;
...
//    private TextView mTitleText;
    ...
    public static class Builder {
        ...
        //Required
        public Builder(@Nullable Activity context, @Nullable MediaPlayerControlListener
        ...
        public Builder withMediaControlListener(@Nullable MediaPlayerControlListener
                                                        mediaControlListener) {
            this.mediaPlayerControlListener = mediaControlListener;
            return this;
        }
     ...
     */
    private class ControllerViewHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case HANDLER_UPDATE_PROGRESS://cycle update seek bar progress
                    ...
                    if (!view.mIsDragging && view.mIsShowing && view.mMediaPlayerControlListener
                            .isPlaying()) {//just in case
                        //cycle update
...
//            add controller view to bottom of the AnchorView
            LayoutParams tlp = new LayoutParams(
                    ...
                    CommonUtils.convertDpToPx(250,mContext));
            mAnchorView.addView(VideoControllerView.this, tlp);

            ViewAnimator.putOn(mBottomLayout)
...
//        mTitleText.setText(mVideoTitle);
    ...
    public int getCurrentPos() {
        return mMediaPlayerControlListener.getCurrentPosition();
    }
    @Override
