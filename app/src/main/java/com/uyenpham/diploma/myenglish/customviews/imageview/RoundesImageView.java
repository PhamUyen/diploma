package com.uyenpham.diploma.myenglish.customviews.imageview;
...
public class RoundesImageView extends ImageView {
    ...
    public RoundesImageView(Context context) {
        super(context);
    }

    public RoundesImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundesImageView(Context context, AttributeSet attrs, int defStyle) {
